package fr.salsa.CVLST.world.gen;
...
public class DenseJungleTreeGen implements IWorldGenerator {
    private final WorldGenerator DENSEJUNGLE = new WorldGenDenseJungleTree();
    ...
    public void generate(Random random, int chunkX, int chunkZ, World world, IChunkGenerator chunkGenerator, IChunkProvider chunkProvider) {
        switch (world.provider.getDimension()){
            case 1:
                break;
            case 0:
                runGenerator(DENSEJUNGLE, world, random, chunkX, chunkZ, 3, -1, 0, DenseJungle.class);
                break;
            case -1:
        }
    }
